...
import { RunAsGetStarted, runGetStartedPage } from './storage/run-as-get-started';
...
resolver.define('runGetStartedPage', async (req): Promise<RunAsGetStarted> => {
	await adminPermissionCheck(req);
	return runGetStartedPage(req);
});
