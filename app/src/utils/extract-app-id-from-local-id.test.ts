...
describe('extractAppIdFromLocalId', () => {
    it('should extract the appId value from localId', () => {
        ...
        const officalLocalId = `ari:cloud:ecosystem::extension/${officialAppId}/2113b3a2-5043-4d97-8db0-31d7e2379e3c/static/jenkins-for-jira-ui-admin-page`;
        ...
        // eslint-disable-next-line max-len
        const outdatedLocalId = `ari:cloud:ecosystem::extension/${outdatedAppId}/2113b3a2-5043-4d97-8db0-31d7e2379e3c/static/jenkins-for-jira-ui-admin-page`;
