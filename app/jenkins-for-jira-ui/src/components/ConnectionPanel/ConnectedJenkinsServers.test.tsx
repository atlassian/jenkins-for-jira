...
describe('timeFromNow util', () => {
	...
	test('should return correct string for single hour', () => {
	...
	test('should return correct string for single minute', () => {
	...
	test('should return correct string for single second', () => {
...
describe('ConnectedJenkinsServers suite', () => {
	...
	test('should render correct job & event content', () => {
		render(<ConnectedJenkinsServers connectedJenkinsServer={mockConnectedJenkinsServer} />);
	...
	test('should render correct time content', () => {
		render(<ConnectedJenkinsServers connectedJenkinsServer={mockConnectedJenkinsServer} />);
